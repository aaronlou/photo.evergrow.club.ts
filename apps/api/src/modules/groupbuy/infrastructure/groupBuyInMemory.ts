...
const demoImage = (i: number): SampleImage => ({
  id: `seed-demo-${i}`,
  url: `/api/groupbuy/images/demo-${i}.svg`,
  uploadedBy: "seed",
})
...
const seedFilms = (): ReadonlyArray<Film> => [
  Film.create({
    id: makeFilmId("film-kodak-gold-200"),
    name: "Kodak Gold 200",
    brand: "Kodak",
    format: "135",
    iso: 200,
  ...
  Film.create({
    id: makeFilmId("film-kodak-portra-400"),
  ...
  Film.create({
    id: makeFilmId("film-kodak-ektar-100"),
